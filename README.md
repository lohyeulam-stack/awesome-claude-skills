...
- [show-me-the-receipts](https://github.com/lohyeulam-stack/show-me-the-receipts) - Forces evidence-first output for reports, retrospectives, and reviews: conclusion up front, facts separated from unknowns, every action with owner/deadline/deliverable, de-AI-ified writing, ADHD-friendly format. *By [@lohyeulam-stack](https://github.com/lohyeulam-stack)*
